    ...
    return (
        <div className="fixed inset-0 z-[100]">
            ...
            {targetRect && (
             ...
             <div
                ref={tooltipRef}
                className={`fixed w-11/12 max-w-xs sm:max-w-sm bg-ocs-dark-sidebar rounded-2xl shadow-2xl border border-white/10 p-4 sm:p-6 text-white tour-tooltip-animate
