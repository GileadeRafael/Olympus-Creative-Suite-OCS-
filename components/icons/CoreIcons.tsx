...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <path d="M5.26 17.242a.75.75 0 10-1.06-1.06l-1.97 1.97a.75.75 0 001.06 1.06l1.97-1.97zM11.25 10.5a.75.75 0 01.75.75v.008c0 .414-.336.75-.75.75h-.008a.75.75 0 01-.75-.75v-.008c0-.414.336.75.75-.75H11.25z" />
  </svg>
);
...
export const LightBulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a3 3 0 00-3-3m3 3a3 3 0 003-3m-3 3V1.5m-3 3h6m-6 3a9 9 0 01-9-9" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18a9 9 0 00-9-9m9 9c-5.004 0-9-4.03-9-9m9 9v-5.25m0 0a3 3 0 013-3m-3 3a3 3 0 01-3-3m3 3V1.5m3 3h-6" />
    </svg>
  );